            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="<?php echo e(route('users.index')); ?>" class="float-right">Back</a>
                    </div>
                    <div class="card-body">
...
unset($__errorArgs, $__bag); ?>" name="username" value="<?php echo e(old('username', $user->username)); ?>" required autocomplete="username" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="first_name" value="<?php echo e(old('first_name', $user->first_name)); ?>" required autocomplete="first_name" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="last_name" value="<?php echo e(old('last_name', $user->last_name)); ?>" required autocomplete="last_name" autofocus>
                ...
                <?php if(auth()->user()->id != $user->id): ?>
                    <div class="m-2 p-2">
                        <form action="<?php echo e(route('users.destroy', $user->id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this user?')">
                            ...
                            <button class="btn btn-danger">Delete <?php echo e($user->username); ?></button>
                        </form>
                    </div>
                <?php endif; ?>
            </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laravel learning\employees\resources\views/users/edit.blade.php ENDPATH**/ ?>